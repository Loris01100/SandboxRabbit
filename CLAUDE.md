...
- [src/client/gestures.ts](src/client/gestures.ts) — les modifications de la grille décrites comme des valeurs (`Gesture`) et leur application. C'est ce qui permet de les rejouer chez l'hôte d'un salon.
